...
class User:
    ...
    def __init__(self, email, screen_name,first_name=None, middle_name=None, last_name=None, oauth_token=None, oauth_token_secret=None, id=None):
        self.email = email
    ...
    def modify_record_in_db(cls, token):
        ...
        token_value=token[0]
        record_type=None
        print('\nModify\n(F)irst Name: {}\n(L)ast Name: {}\n(E)mail Address: {}\n'.format(record_to_modify.first_name,record_to_modify.last_name,record_to_modify.email))
